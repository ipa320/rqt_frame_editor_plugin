...
## PROXY ##
##
def Proxy_Request(proxy_type, proxy_type_module, proxy_type_name, proxy_name, name, description, icon_path):
    request = AddProxy()

    request.proxy_type = proxy_type
    request.proxy_type_module = proxy_type_module
    request.proxy_type_name = proxy_type_name
    request.proxy_name = proxy_name
    request.name = name
    request.description = description
    request.icon_path = icon_path
...
class Proxy:
    ...
    def remove_provider(self, provider_name):
        print "Removing prodiver:", provider_name
